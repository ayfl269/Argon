...
function themeoptions_page(){
	/*主题选项*/
?>
<script src="<?php echo ARGON_MODERN_URL; ?>/assets/vendor/jquery/jquery.min.js"></script>
	<script src="<?php echo ARGON_MODERN_URL; ?>/assets/vendor/headindex/headindex.js"></script>
	...
	<script src="<?php echo ARGON_MODERN_URL; ?>/assets/vendor/dragula/dragula.min.js"></script>
	<div>
		<style type="text/css">
			h2{
				font-size: 25px;
		...
		<form method="POST" action="" id="main_form">
			...
			<table class="form-table">
				<tbody>
					...
					<tr>
						<th><label><?php _e('页面 URL 后缀 (.html)', 'argon');?></label></th>
						<td>
							<select name="argon_page_add_html">
								<?php $argon_page_add_html = get_option('argon_page_add_html'); ?>
								<option value="false" <?php if ($argon_page_add_html=='false'){echo 'selected';} ?>><?php _e('不启用', 'argon');?></option>
								<option value="true" <?php if ($argon_page_add_html=='true'){echo 'selected';} ?>><?php _e('启用', 'argon');?></option>
							</select>
