<?php
/**
 * Template part for displaying posts in preview style 2
 *
 * @package ArgonModern
 */
...
$has_thumbnail = $template::has_post_thumbnail();
?>

<article class="post card bg-white shadow-sm border-0 <?php if ($options->get('enable_into_article_animation', 'true') == 'true'){echo 'post-preview';} ?> post-preview-layout-2" id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
